    ...
    <div class="row">
        ...
        if(isset($_POST["search"]) ){
            if($_POST["typesearch"]=="classname"){
                $sql = 'select * from lophoc, people where lophoc.ma_lophoc=people.ma_lophoc  and lophoc.ten_lophoc like "%'.$_POST["search"].'%"';

                $lophoc = executeResult($sql);
            }elseif ($_POST["typesearch"]=="subjectname"){
                $sql = 'select * from lophoc, people where lophoc.ma_lophoc=people.ma_lophoc  and lophoc.ten_monhoc like "%'.$_POST["search"].'%" ';
                $lophoc = executeResult($sql);

            }else{
                $sql = 'select * from lophoc, people where lophoc.ma_lophoc=people.ma_lophoc and lophoc.ten_phonghoc like "%'.$_POST["search"].'%"';
                $lophoc = executeResult($sql);
